...
using WorldServer.player.skills.agility;
using WorldServer.util;

namespace WorldServer.minigames.agilityarena
{
		    ...
		    switch(status) {
			    ...
			    case 35:
				    ...
				    if (p.getSkills().getMaxLevel(Skills.SKILL.AGILITY) < 99) {
					    ...
					    p.getPackets().modifyText("to those that have conquered the obstacles of World,", 244, 5);
